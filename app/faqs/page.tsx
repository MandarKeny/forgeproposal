...
export default function FAQs() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "ProposalForge is tailored for IT services proposals and leverages advanced AI to create Shipley-compliant drafts of 40-60 pages in minutes. It automatically integrates win themes, maintains consistent voice and style, and reduces editing time. Features like semantic search, automatic indexing, compliance checks, and push-button reports set it apart as a comprehensive solution."
    },
    {
