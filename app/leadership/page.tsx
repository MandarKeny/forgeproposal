        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="bg-gray-50 border-gray-200">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600">
                A Machine Learning Engineer at Walmart Global Tech, Shreenidhi
                has experience at Amazon, eBay, and Cisco. He excels in anomaly
                detection and ML pipelines and is pursuing an Executive MBA at
                Chicago Booth. Passionate about AI, he mentors engineers
                transitioning into the field and is certified in digital marketing
                by Google and Meta.
              </p>
            </CardContent>
          </Card>
