          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-8">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  ProposalForge empowers your team with ProposalForge&apos;s expertise, fostering collaboration and knowledge sharing, allowing for quicker and more effective responses to opportunities.
                </p>
              </div>
              <div>
